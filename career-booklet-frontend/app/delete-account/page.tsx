...
import { deleteAccount, sendOtp } from '@/app/api/auth_service_others/route';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!otpSent) {
      ...
      try {
        ...
        await deleteAccount(userId, otpValue);
      ...
      <div className="text-center text-lg font-bold">
        ...
        <div className="w-full max-w-sm mx-auto bg-yellow-100 text-gray-800 p-4 mt-4 rounded-lg text-sm">
          <p className="text-center">
            <span className='text-red-900'>WARNING:</span> Deleting your account will permanently remove your data and access to all services.
          </p>
          <p className="text-center">
            If you wish, you can <Link className='text-indigo-600' href="/deactivate-account">try deactivating</Link> your account instead.
          </p>
        </div>
      </div>
